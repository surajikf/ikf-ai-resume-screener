import { FaClock, FaSyncAlt, FaFolderOpen, FaTrash } from "react-icons/fa";
      ...
      <div className="max-h-56 space-y-2 overflow-y-auto px-4 py-3">
        {jdHistory.length === 0 && (
          <p className="text-sm text-slate-500">
            Saved job descriptions will appear here.
          </p>
        )}
        {jdHistory.map((jd) => (
          <div
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="rounded-md border border-slate-200 p-1 text-slate-400 transition hover:border-red-200 hover:text-red-600"
                >
                  <FaTrash />
                </button>
              </div>
            </div>
            <p className="max-h-12 overflow-hidden text-ellipsis text-xs text-slate-500">
              {jd.content}
            </p>
          </div>
        ))}
